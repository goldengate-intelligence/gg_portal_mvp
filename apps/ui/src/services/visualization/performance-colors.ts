...
class PerformanceColorsService {
	 ...
	 */
	getColorWithOpacity(score: number, opacity = 1): string {
	 ...
	 */
	getBackgroundColor(score: number, opacity = 0.1): string {
	 ...
	 */
	getBorderColor(score: number, opacity = 0.8): string {
		return this.getColorWithOpacity(score, opacity);
	}
