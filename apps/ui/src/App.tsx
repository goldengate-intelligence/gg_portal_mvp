			...
			<div className="h-full flex items-center justify-center">
				<div className="container mx-auto px-6 max-w-4xl">
					<div className="text-center">
						<HeroText />
						<h2
							className="text-gray-400 mb-6 hero-subtext"
							style={{
						...
						{isAuthenticated ? (
							<div className="flex justify-center">
								<Button
									asChild
									className="bg-[#D2AC38] hover:bg-[#D2AC38]/80 text-black text-lg px-8 py-4"
								>
							...
							<div className="flex flex-col sm:flex-row gap-4 justify-center group">
								<Button
									asChild
									className="bg-[#D2AC38] group-hover:bg-transparent group-hover:border group-hover:border-[#D2AC38] group-hover:text-[#D2AC38] hover:bg-[#D2AC38]/80 text-black text-lg px-8 py-4 transition-all duration-200"
								...
								<Button
									asChild
									variant="outline"
									className="border-[#D2AC38] text-[#D2AC38] hover:bg-[#D2AC38] hover:text-black text-lg px-8 py-4 transition-all duration-200"
									style={{ fontFamily: "system-ui, -apple-system, sans-serif" }}
								>
					...
					<div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-8">
						<div className="text-center p-6 rounded-lg bg-gray-800/50 backdrop-blur border border-[#D2AC38]/30 hover:border-[#D2AC38]/60 transition-all duration-300">
							...
							<h3
								className="text-lg font-semibold mb-4 text-[#D2AC38] uppercase"
								style={{
							...
							<p className="text-gray-300 leading-relaxed text-sm">
								Enterprise-grade infrastructure designed for streamlined
								deployment.
							</p>
						</div>
						...
						<div className="text-center p-6 rounded-lg bg-gray-800/50 backdrop-blur border border-[#D2AC38]/30 hover:border-[#D2AC38]/60 transition-all duration-300">
							...
							<p className="text-gray-300 leading-relaxed text-sm">
								First-of-its-kind architecture optimized for seamless autonomous
								workflows.
							</p>
						</div>
						...
						<div className="text-center p-6 rounded-lg bg-gray-800/50 backdrop-blur border border-[#D2AC38]/30 hover:border-[#D2AC38]/60 transition-all duration-300">
							...
							<p className="text-gray-300 leading-relaxed text-sm">
								Zero-trust security framework with defense-grade access control
								systems.
							</p>
						</div>
					</div>
