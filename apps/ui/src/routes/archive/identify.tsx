...
import { Search, Filter, Download, Save, ChevronLeft, ChevronRight, Crosshair, Database, Terminal, FolderOpen, FileDown, Globe, BarChart3, TrendingUp, Activity, Shield, Zap, Target, Radar, Cpu, MonitorSpeaker } from 'lucide-react';
    ...
    <div className="w-full bg-gradient-to-br from-black/95 via-gray-900/90 to-black/95 backdrop-blur-sm border border-cyan-500/30 rounded-lg overflow-hidden relative">
      ...
      <div className="relative p-6 border-b border-cyan-500/20 bg-gradient-to-r from-black/80 via-gray-900/40 to-black/80">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative">
              ...
              <div className="absolute inset-0 rounded-xl overflow-hidden">
                ...
                <div className="absolute bottom-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-[#D2AC38]/60 to-transparent animate-pulse" style={{ animationDelay: '0.5s' }} />
              </div>
            </div>

            <div>
              <div className="flex items-center gap-3 mb-1">
                <h1 className="text-2xl font-black text-transparent bg-clip-text bg-gradient-to-r from-[#D2AC38] via-orange-400 to-[#D2AC38] uppercase tracking-wider" style={{ fontFamily: 'Orbitron, monospace' }}>
                  Entity Identification System
                </h1>
                <div className="flex items-center gap-1">
                  <Zap className="w-4 h-4 text-cyan-400 animate-pulse" />
                  <span className="text-xs text-cyan-400 font-sans font-bold uppercase tracking-wide">v2.1.7</span>
                </div>
              </div>
              <div className="flex items-center gap-4">
                <p className="text-sm text-white font-sans tracking-wide">
                  <span className="text-cyan-400">SCANNING</span> GOLDENGATE DATABASE •
                  <span className="text-[#D2AC38] font-bold"> {pagination?.total?.toLocaleString() || '0'} ENTITIES</span> IDENTIFIED
                </p>
                {aggregations && (
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-3 px-4 py-2 bg-black/50 border border-cyan-500/30 rounded-lg backdrop-blur-sm">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs text-cyan-400 font-sans uppercase tracking-wide">SCANNING</span>
              </div>
              <div className="w-px h-4 bg-cyan-500/30" />
              <div className="flex items-center gap-2">
                <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse" />
                <span className="text-xs text-green-400 font-sans uppercase font-bold">ONLINE</span>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-1">
              <div className="flex gap-1">
                {[0, 1, 2].map(i => (
                  <div key={i} className="w-1 h-3 bg-cyan-400/60 rounded-full animate-pulse" style={{ animationDelay: `${i * 0.2}s` }} />
                ))}
              </div>
        ...
        <div className="mt-4 h-1 bg-gray-800 rounded-full overflow-hidden">
          <div className="h-full bg-gradient-to-r from-cyan-400 via-[#D2AC38] to-orange-500 rounded-full animate-pulse" style={{ width: '100%' }} />
        </div>
      </div>
          ...
          <div className="mt-6 pt-6 border-t border-gradient-to-r from-transparent via-cyan-500/20 to-transparent relative">
            ...
            <div className="flex items-center gap-3 mb-4">
              <div className="flex items-center gap-2 px-3 py-1 bg-gradient-to-r from-cyan-500/20 to-blue-500/20 border border-cyan-500/30 rounded-lg">
                ...
                <span className="text-sm font-sans text-cyan-400 uppercase font-bold tracking-wide">TARGET ACQUISITION</span>
              </div>
                ...
                <div className="relative">
                  ...
                  <div className="absolute right-4 top-1/2 -translate-y-1/2 flex items-center gap-2">
                    <div className="flex items-center gap-1">
                      ...
                      <span className="text-xs text-gray-500 font-sans uppercase">AI ASSIST</span>
                    </div>
                    <div className="w-px h-4 bg-gray-600" />
                    <span className="text-xs text-gray-500 font-sans uppercase">QUERY</span>
                  </div>
                  {searchQuery && (
                    <div className="absolute -bottom-6 left-0 right-0">
                      <div className="flex items-center gap-2 text-xs text-cyan-400 font-sans">
                        <div className="w-1 h-1 bg-cyan-400 rounded-full animate-pulse" />
                        <span>Scanning {pagination?.total?.toLocaleString() || '0'} entities...</span>
                      </div>
                    </div>
                  )}
                </div>
              ...
              <div className="flex items-center gap-6">
                ...
                <div className="flex items-center gap-3 px-4 py-2 bg-black/60 border border-green-500/30 rounded-lg backdrop-blur-sm">
                  ...
                  <div className="flex flex-col">
                    <span className="text-xs text-gray-400 font-sans uppercase">System Status</span>
                    <span className={cn(
                ...
                {pagination && (
                  <div className="flex items-center gap-3 px-4 py-2 bg-black/60 border border-cyan-500/30 rounded-lg backdrop-blur-sm">
                    ...
                    <div className="flex flex-col">
                      <span className="text-xs text-gray-400 font-sans uppercase">Target Count</span>
                ...
                {aggregations && (
                  <div className="flex items-center gap-3 px-4 py-2 bg-black/60 border border-[#D2AC38]/30 rounded-lg backdrop-blur-sm">
                    ...
                    <div className="flex flex-col">
                      <span className="text-xs text-gray-400 font-sans uppercase">Total Value</span>
                ...
                <div className="flex items-center gap-3 px-4 py-2 bg-black/60 border border-blue-500/30 rounded-lg backdrop-blur-sm">
                  ...
                  <div className="flex flex-col">
                    <span className="text-xs text-gray-400 font-sans uppercase">Response Time</span>
              ...
              {pagination && pagination.totalPages > 1 && (
                <div className="flex items-center gap-3">
                  <div className="flex items-center gap-2 px-3 py-2 bg-black/60 border border-gray-600/30 rounded-lg backdrop-blur-sm">
                    <span className="text-xs text-gray-400 font-sans uppercase">Page</span>
            ...
            <div className="mt-4 flex items-center gap-2">
              <div className="h-1 flex-1 bg-gray-800 rounded-full overflow-hidden">
                <div className={cn(
                  ...
                  isLoading ? "w-full bg-gradient-to-r from-cyan-500 via-blue-500 to-cyan-500 animate-pulse" :
                  error ? "w-0 bg-red-500" :
