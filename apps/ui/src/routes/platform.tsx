	...
	const modes = [
		{
			...
			description:
				"Primary research workspace for discovering, analyzing, and investigating federal contractors and organizations",
			icon: Brain,
			...
			capabilities: [
				{
					icon: Search,
					label: "Asset Origination",
					desc: "Advanced contractor discovery",
				},
				{
					icon: Eye,
					label: "Forensic Due Diligence",
					desc: "Comprehensive entity profiling",
				},
				{
					icon: Globe,
					label: "Business Development",
					desc: "Contact intelligence via Lusha",
				},
			],
		},
		{
			...
			description:
				"Organize and manage your saved entities with grouping, tagging, and aggregation capabilities",
			icon: Folder,
			...
			capabilities: [
				{
					...
					desc: "Organize saved contractors",
				},
				{
					icon: BarChart3,
					label: "Risk Monitoring",
					desc: "Portfolio risk assessment",
				},
				{
					icon: FolderOpen,
					label: "Presentation Builder",
					desc: "Construct compelling client decks",
				},
			],
		},
	];
			...
			<div className="min-h-screen w-full text-white bg-gradient-to-b from-black/90 via-gray-900/50 to-black/90">
				<div className="container mx-auto px-6 pt-24 pb-20 max-w-7xl">
					...
					<div className="text-center mb-6 mt-8">
						...
						>
							<span className="text-[#D2AC38]" style={{ fontWeight: "250" }}>
								Select
							</span>{" "}
							<span className="text-white" style={{ fontWeight: "100" }}>
								Function
							</span>
						</h1>
						<p
