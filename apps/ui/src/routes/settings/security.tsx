...
import { FormSection, FormField, FormCheckbox, FormActions, SaveButton, CancelButton } from '../../components/settings/form-components';
        ...
        <div className="p-6 space-y-8">
              ...
              <div className="flex-1">
                ...
                {securitySettings.twoFactorEnabled ? (
                  <div className="flex items-center gap-2">
                    ...
                    <button className="text-red-400 text-sm hover:text-red-300 ml-4">Disable</button>
                  </div>
                ) : (
          ...
          <form onSubmit={handleSecuritySubmit}>
            ...
            >
              ...
              <FormActions>
                <SaveButton loading={loading}>Save Security Settings</SaveButton>
              </FormActions>
            </FormSection>
          </form>
          ...
          >
            <div className="space-y-4">
              {sessions.map((session) => (
                <div key={session.id} className="flex items-center justify-between p-4 rounded-lg border border-gray-600/30 bg-gray-800/30">
          ...
          <div className="flex items-start gap-4 p-4 rounded-lg bg-amber-500/10 border border-amber-500/30">
            ...
            <div>
              <h4 className="text-amber-400 font-medium mb-2" style={{ fontFamily: 'system-ui, -apple-system, sans-serif' }}>
...
export const securitySettingsRoute = (rootRoute: any) => createRoute({
