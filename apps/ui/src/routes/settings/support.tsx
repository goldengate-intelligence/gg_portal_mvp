	...
	const faqItems = [
		{
			...
			answer:
				"Portfolio data is updated in real-time during market hours, with overnight processing for comprehensive analysis. Historical data is refreshed daily.",
		},
		{
			question: "Can I export my portfolio data?",
			answer:
				"Yes, you can export your portfolio data in multiple formats including CSV, Excel, and PDF. Visit the Analytics section to access export options.",
		},
		{
			question: "How do I reset my password?",
			answer:
				'Go to the login page and click "Forgot Password". You can also change your password in Account Security settings if you\'re already logged in.',
		},
		{
		...
		},
		{
			...
			answer:
				"You can submit a support ticket through this page, email us at support@goldengateintelligence.com, or call us during business hours.",
		},
		{
			question: "Is my data secure?",
			answer:
				"Yes, we use enterprise-grade security including encryption, secure data centers, and regular security audits. Your data is never shared with third parties.",
		},
	];
					...
					>
						<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
							{documentationSections.map((section) => (
								<div
									key={section.title}
									className="p-4 rounded-lg bg-gray-800/30 border border-gray-600/20"
								>
					...
					>
						...
						<div className="space-y-4">
							{filteredFAQ.map((item, index) => (
								<details
									key={index}
									className="group rounded-lg bg-gray-800/30 border border-gray-600/20"
								>
...
export const helpSupportRoute = (rootRoute: any) =>
	createRoute({
