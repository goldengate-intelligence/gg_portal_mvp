...
function UsageAnalyticsComponent() {
	...
	const usageStats = MOCK_USAGE_STATS;
					...
					>
						<div className="space-y-3">
							{usageStats.mostViewedPages.map((page, index) => (
								<div
									key={page.page}
									className="flex items-center justify-between p-3 rounded-lg bg-gray-800/30 border border-gray-600/20"
								>
...
export const usageAnalyticsRoute = (rootRoute: any) =>
	createRoute({
