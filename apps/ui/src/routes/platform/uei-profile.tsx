        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex items-center gap-2 mb-4">
              <Badge className="bg-yellow-500/20 text-yellow-400 border-yellow-500/50 font-sans">
                  ...
                  <div className="space-y-2">
                    {profile.naicsCodes?.map((naics, idx) => (
                      <div key={idx} className="flex items-center justify-between bg-dark-gray p-2 rounded">
                        <div className="flex items-center gap-2">
                          <span className="font-sans text-sm text-white">{naics.code}</span>
                          {naics.isPrimary && (
            ...
            <Card className="bg-medium-gray border-gray-700">
              ...
              <CardContent className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="font-sans text-white">{profile.uei}</span>
                </div>
                {profile.cageCode && (
                  <div className="flex justify-between">
                    <span className="text-sm text-gray-400">CAGE Code</span>
                    <span className="font-sans text-white">{profile.cageCode}</span>
                  </div>
                )}
                {profile.dodaac && (
                  <div className="flex justify-between">
                    <span className="text-sm text-gray-400">DODAAC</span>
                    <span className="font-sans text-white">{profile.dodaac}</span>
                  </div>
                )}
                <div className="flex justify-between">
