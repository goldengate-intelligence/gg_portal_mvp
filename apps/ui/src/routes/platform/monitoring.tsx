...
export const portfolioPerformanceRoute = (rootRoute: any) => createRoute({
...
export const portfolioActivityRoute = (rootRoute: any) => createRoute({
  getParentRoute: () => rootRoute,
...
export const portfolioUtilizationRoute = (rootRoute: any) => createRoute({
  getParentRoute: () => rootRoute,
