				...
				<div className="container mx-auto px-6 pt-24 pb-20 relative z-10">
					...
					<div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
						...
						<div className="lg:col-span-1">
							<div
								className="h-full border border-gray-700/50 hover:border-gray-600/40 rounded-xl overflow-hidden shadow-2xl transition-all duration-500 group relative"
							...
							>
								...
								<div className="p-6 relative z-10">
									...
									<div
										className="p-6 border border-gray-700 rounded-xl relative overflow-hidden"
										style={{
									...
									>
										<dl className="space-y-4">
											...
											<div>
												...
												<dd className="text-sm text-gray-400 mt-1 capitalize font-medium">
													{user?.role}
												</dd>
											</div>
											<div>
												...
												<dd className="text-sm text-gray-400 font-sans mt-1 text-xs">
													{user?.tenantId}
												</dd>
											</div>
											<div>
										...
										<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
											{userSettings.map((setting, index) => (
												<Link
													key={setting.label}
													to={setting.href}
													className="p-6 border border-gray-700 hover:border-[#D2AC38]/50 rounded-lg transition-all cursor-pointer group relative overflow-hidden block"
													style={{
														backgroundColor:
															CONTRACTOR_DETAIL_COLORS.containerColor,
													}}
												>
													<div className="flex items-start gap-3">
														<setting.icon
															className="text-[#D2AC38] group-hover:text-[#D2AC38] transition-colors mt-1"
															style={{ width: "30px", height: "30px" }}
														/>
														<div>
															<h4
																className="font-medium text-white group-hover:text-[#D2AC38] transition-colors"
																style={{
								...
								>
									...
									<div className="p-6 relative z-10">
										...
										<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
											<Button
												asChild
												className="bg-[#F97316] hover:bg-[#F97316]/80 text-white font-bold w-full"
											>
												<Link to="/platform/discovery">DISCOVER ASSETS</Link>
											</Button>
											<Button
												asChild
												className="bg-[#6366F1] hover:bg-[#6366F1]/80 text-white font-bold w-full"
											>
...
export const dashboardRoute = (rootRoute: any) =>
	createRoute({
