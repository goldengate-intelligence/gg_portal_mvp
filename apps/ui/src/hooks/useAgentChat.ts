...
const INITIAL_MESSAGE: ChatMessage = {
	id: "welcome",
	content:
		"Hi! I'm Midas, your GoldenGate AI agent. I can help you:\n\n• Find and research contractors\n• Analyze market data and trends\n• Manage your portfolio\n• Generate reports and insights\n\nWhat would you like to explore today?",
	role: "agent",
	timestamp: new Date(),
	type: "text",
};
...
function generateAgentResponse(
	...
	if (
		input.includes("configure my monitoring dashboard") ||
		metadata?.context === "risk_configuration"
	) {
		return {
...
What would you like to work on?`,
	...
	if (
		input.includes("research and take notes") ||
		input.includes("set notes") ||
		input.includes("notes mode")
	) {
		const entityName =
			userInput.match(/on (.+)\.$/)?.[1] ||
			userInput.match(/for (.+)$/)?.[1] ||
			"this entity";
		return {
