      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription>Performance metrics vs industry peers</CardDescription>
          </div>
              ...
              return (
                <div key={item.metric} className="p-2 bg-gray-800/50 rounded">
                  ...
                  <div className="flex items-center gap-1 mt-1">
                    <span className="text-sm font-medium text-white">{item.contractor}</span>
                    <span className={`text-xs ${isAbove ? 'text-green-500' : 'text-red-500'}`}>
