...
export function classifyContractor(
	...
	return {
		...
		primaryDescription: getDescriptionBySpecificity(
			naicsMatch,
			specificityLevel,
		),
		businessSummary,
...
function generateBusinessSummary(
	...
	const primaryActivity =
		naicsMatch.naics_6_description ||
	...
	if (pscMappings.length > 0) {
		const pscContext =
			pscMappings[0].psc_4_char_description ||
 ...
 */
function getDescriptionBySpecificity(
	naicsMatch: NAICSHierarchy | null,
	level: number,
): string {
	...
	switch (level) {
		case 6:
			return naicsMatch.naics_6_description || naicsMatch.naics_5_description;
		case 5:
			return naicsMatch.naics_5_description || naicsMatch.naics_4_description;
		case 4:
			return naicsMatch.naics_4_description || naicsMatch.naics_3_description;
		case 3:
			return naicsMatch.naics_3_description || naicsMatch.naics_2_description;
		default:
			return naicsMatch.naics_2_description;
	}
}
 ...
 */
export function isDefenseContractor(
...
export function getContractorSummaryLine(
	...
	const classification = classifyContractor(
		naicsCode,
		pscCodes,
		businessDescription,
	);
