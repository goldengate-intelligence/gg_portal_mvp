...
export function AwardCardView({
	...
	// Transform real relationship contracts into Event format for display
	...
	const obligations: Event[] = relationship?.contracts?.map((contract: any, index: number) => ({
	...
	const getLatestActionDate = (awardKey: string) => {
		// Get all events for this award key
		const eventsForAward = obligations.filter(event =>
														...
														<div className="flex items-start justify-between">
															...
															<div className="flex flex-col items-end gap-3">
																...
																<div className="flex items-center px-3 py-1 bg-gray-600/20 border border-gray-600/40 rounded-full gap-2 transition-all duration-200 hover:bg-gray-600/30 hover:border-gray-600/60">
																	...
																	{/* Calendar Icon - Go Deeper (Obligations) */}
																	<div
																		...
																		onClick={(e) => {
																			...
																			e.preventDefault();
																			setActiveTooltip(null);
																			console.log('Orange calendar clicked! Event data:', event);
																			console.log('Award PIID:', event.award_piid);
																			console.log('AI Description:', event.ai_description);
																			// Navigate to obligation grain view
																			onOpenObligationCardView(event.award_piid || event.id || 'Unknown Contract', event.ai_description || event.desc || 'Contract Activities', type);
																		}}
																	>
																		<svg
																			...
																			style={{
																				animation:
																					"dramaticGlow 3s ease-in-out infinite alternate",
																			}}
																		>
																			<path
																				strokeLinecap="round"
														...
														<div className="grid grid-cols-4 gap-4">
															...
															<div className="bg-gray-800/30 rounded p-3 border border-gray-700/30 text-center transition-all duration-300 hover:bg-gray-800/40 hover:border-gray-700/50">
																...
																<span
																	...
																	style={{ color: "#10B981" }}
																>
																	{formatMoneyMillions(event.event_amount * 0.75)}
																</span>
															</div>
															<div className="bg-gray-800/30 rounded p-3 border border-gray-700/30 text-center transition-all duration-300 hover:bg-gray-800/40 hover:border-gray-700/50">
																<span
