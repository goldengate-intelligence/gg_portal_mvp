...
import { calculateContractTimeline, getTimelineColor, getUtilizationColor } from '../logic/contractCalculations';

export function ContractDetails({ contract }: ContractDetailsProps) {
  const { progressPercent, remainingMonths } = calculateContractTimeline(contract);
        ...
        <div className="grid grid-cols-3 gap-3 mt-3 pt-3 border-t border-gray-700/30">
          ...
          <div>
            ...
            <div className="flex justify-between text-[8px] text-gray-500 mt-1">
              ...
              <span className="font-bold" style={{ color: getTimelineColor(remainingMonths) }}>
          ...
          <div>
            ...
            <div className="text-[8px] text-center mt-1">
              <span className="font-bold" style={{ color: getUtilizationColor(contract.utilization) }}>
