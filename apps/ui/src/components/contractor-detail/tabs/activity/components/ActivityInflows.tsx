...
export function ActivityInflows({
  ...
  const totalInflows = sortedInflowRelationships.agencies.length + sortedInflowRelationships.primes.length;
          ...
          {sortedInflowRelationships.agencies.map((relationship) => {
            ...
            return (
              <RelationshipCard
                ...
                onOpenEventsDetail={(relationship, _, event) => onOpenEventsDetail(relationship, 'inflow', event)}
              />
            );
          })}
