            ...
            <div className="grid grid-cols-2 gap-8 relative">
              ...
              <div className="rounded-xl backdrop-blur-sm p-4" style={{ backgroundColor: CONTRACTOR_DETAIL_COLORS.containerColor }}>
                ...
                <div className="mt-3 p-2 rounded-lg bg-gradient-to-r from-[#15803d]/10 to-transparent border-l-2 border-[#15803d]">
                  <div className="text-white text-sm">Exceptional pipeline value places contractor in elite tier for business development capabilities</div>
                </div>
              </div>
              ...
              <div className="rounded-xl backdrop-blur-sm p-4" style={{ backgroundColor: CONTRACTOR_DETAIL_COLORS.containerColor }}>
                ...
                <div className="mt-3 p-2 rounded-lg bg-gradient-to-r from-[#eab308]/10 to-transparent border-l-2 border-[#eab308]">
                  <div className="text-white text-sm">Portfolio duration suggests opportunities to extend contract lifecycles and improve retention</div>
                </div>
              </div>
