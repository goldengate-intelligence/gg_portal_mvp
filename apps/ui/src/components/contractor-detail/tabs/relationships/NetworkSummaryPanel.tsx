				...
				<div className="p-4 h-full flex flex-col relative z-10">
					...
					<div className="grid grid-cols-2 gap-4 flex-1 items-stretch">
						...
						<div className="col-span-1">
							<div
								className="border border-gray-700 rounded-xl backdrop-blur-sm p-4"
								style={{
								...
								<div>
									<div className="space-y-3">
										...
										<div className="space-y-3">
											...
											<div
												className="rounded-lg p-3 border border-[#D2AC38]/20"
											...
											>
												...
												<div className="text-[13px] text-gray-400 leading-relaxed mb-2">
													Manufacturing armor systems and structural components
													for defense vehicles. Trusted by{" "}
											...
											<div className="space-y-3">
												{/* Agency Direct */}
												<div
													className="flex items-start gap-3 rounded-lg p-3 border border-gray-700"
													style={{ backgroundColor: "#03070F" }}
												>
						...
						<div className="col-span-1">
							...
							>
								...
								<div
									className="flex-1 relative overflow-hidden rounded-lg transition-all duration-300 min-h-[400px] border border-[#D2AC38]/30"
									style={{
										background: "linear-gradient(to bottom, #0C1524, #0C1524)",
									}}
								>
