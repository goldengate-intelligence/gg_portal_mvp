			...
			>
				<div className="p-4 relative flex flex-col h-full">
					...
					<div className="flex-1 grid grid-cols-2 gap-4">
						...
						<div
							className="border border-gray-700 rounded-xl backdrop-blur-sm p-4 flex flex-col"
							style={{
						...
						>
							<div className="flex items-center justify-between mb-2">
								...
								<div className="flex items-center gap-2">
									...
									<span
										className="text-[10px] text-[#22c55e] font-light"
										style={{
							...
							<div className="flex-1 relative rounded-lg overflow-hidden min-h-[316px]">
								...
								<div
									className="h-full border border-gray-700 backdrop-blur-sm rounded-lg p-3 flex flex-col"
								...
								>
									...
									<div className="grid grid-cols-3 gap-3 mb-2">
										<div className="text-center">
											...
											>
												Agency Direct Awards
											</div>
											<div className="py-0.5">
												<div
													className="font-bold text-[#22c55e] leading-tight"
													style={{ fontSize: "38px" }}
												>
													$50M
												</div>
									...
									>
										...
										{[
											...
											// Additional Places of Performance - Prime Partner projects
											{
												...
												name:
													networkData.relationships?.asSubcontractor
														?.partners?.[0]?.primeName || "MegaCorp Industries",
