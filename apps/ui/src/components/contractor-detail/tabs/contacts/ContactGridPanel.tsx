...
export function ContactGridPanel({
  ...
  if (loading) {
    return (
      <Card
        className={PanelWrapper.hudCard}
      >
      ...
      {people.map((person) => (
        ...
        >
          <div className="p-4 flex flex-col h-full relative z-10">
            ...
            <div className="border border-gray-700 rounded-lg p-3 space-y-2.5" style={{ backgroundColor: CONTRACTOR_DETAIL_COLORS.containerColor }}>
              {/* Email */}
