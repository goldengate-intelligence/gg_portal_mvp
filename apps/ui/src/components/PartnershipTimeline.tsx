...
const PartnershipTimeline: React.FC<PartnershipTimelineProps> = ({
	...
	return (
		<div className="w-full h-full flex flex-col">
			<h3
				className="text-2xl text-gray-200 font-normal tracking-wider mb-3"
				...
				<div className="absolute bottom-0 left-24 right-4 flex items-center justify-between text-xs text-gray-400 pt-2 border-t border-gray-700/30">
					<div className="flex items-center gap-4">
						<div className="flex items-center gap-1">
							<div className="w-4 h-4 rounded-full border-2 border-[#5BC0EB] bg-[#5BC0EB]/20" />
							<span>Prime Partner</span>
						</div>
						<div className="flex items-center gap-1">
							<div className="w-4 h-4 rounded-full border-2 border-[#FF4C4C] bg-[#FF4C4C]/20" />
					...
					<div className="text-[#D2AC38]">Total shown on right</div>
				</div>
			</div>
		</div>
	);
