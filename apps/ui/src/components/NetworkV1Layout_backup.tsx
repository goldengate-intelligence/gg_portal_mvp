		...
		<div className="p-4 h-full flex flex-col">
			...
			<div className="grid grid-cols-2 gap-6 flex-1">
				...
				<div className="col-span-1">
					<div
						className="border border-gray-600/20 rounded-xl backdrop-blur-sm p-4 h-full"
									...
									<div className="bg-gradient-to-br from-[#D2AC38]/5 to-black/30 rounded-lg p-3 border border-[#D2AC38]/20">
										<div className="flex items-center justify-between mb-3">
											...
											<div className="flex gap-2">
												<div className="px-2 py-0.5 bg-[#D2AC38]/10 rounded text-[9px] text-[#D2AC38]">
													NAICS 332312
												</div>
											</div>
										</div>
										...
										<div className="text-[11px] text-gray-400 leading-relaxed mb-2">
											Manufacturing armor systems and structural components for
											defense vehicles. Trusted by{" "}
											<span className="text-[#7B61FF]">DOD</span> with direct
											awards, integrated with{" "}
										...
										<div className="text-[10px] text-gray-300 mb-2">
											Military vehicle armor • Structural assemblies • Precision
											hardware
										</div>
										...
										<div className="mt-2 pt-2 border-t border-gray-700/30">
											<div className="text-[10px]">
												...
												<span className="text-gray-300">5110, 5340, 9515</span>
											</div>
										</div>
									</div>
										...
										<div className="flex items-start gap-3 bg-black/20 rounded-lg p-3 border border-gray-700/20">
											<div className="mt-0.5">
												<div className="w-10 h-10 rounded-full bg-[#7B61FF]/20 border-2 border-[#7B61FF]/60 flex items-center justify-center">
													<span className="text-[14px] text-[#7B61FF] font-bold">
														A
													</span>
												</div>
											</div>
											<div className="flex-1">
												<div className="flex items-center gap-2 mb-1">
													...
													<span className="text-[11px] text-[#7B61FF]">
														→ DIRECT AWARDS
													</span>
												</div>
										...
										<div className="flex items-start gap-3 bg-black/20 rounded-lg p-3 border border-gray-700/20">
											...
											<div className="flex-1">
												<div className="flex items-center gap-2 mb-1">
													...
													<span className="text-[11px] text-[#5BC0EB]">
														→ SUBCONTRACT AWARDS
													</span>
												</div>
												<div className="text-[11px] text-gray-400">
													Manufacturing support for MegaCorp Industries & Global
													Defense Systems
												</div>
												<div className="text-[10px] text-gray-500 mt-1">
										...
										<div className="flex items-start gap-3 bg-black/20 rounded-lg p-3 border border-gray-700/20">
											...
											<div className="flex-1">
												<div className="flex items-center gap-2 mb-1">
													...
													<span className="text-[11px] text-[#FF4C4C]">
														→ PROCUREMENT ORDERS
													</span>
												</div>
												<div className="text-[11px] text-gray-400">
				...
				<div className="col-span-1">
					<div
						className="border border-gray-600/20 rounded-xl backdrop-blur-sm p-4 flex flex-col h-full"
						style={{ backgroundColor: CONTRACTOR_DETAIL_COLORS.containerColor }}
					>
						<div className="flex items-center justify-between mb-2">
							<h4 className="font-sans text-xs uppercase tracking-wider text-gray-500">
							...
							<div className="grid grid-cols-3 gap-2 text-center">
								<div>
									...
									<div className="text-green-400 font-medium text-lg">
										...
										{(
											50 +
											(networkData.relationships?.asSubcontractor?.totalValue ||
												0) /
												1000000
										).toFixed(1)}
										M
