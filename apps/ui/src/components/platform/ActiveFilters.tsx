  ...
  return (
    <div className="mt-3 p-3 bg-gray-800 rounded-lg">
      <div className="flex items-center justify-between mb-2">
        <span className="text-xs text-gray-400 font-aptos">Active Filters:</span>
        <Button
          variant="ghost"
          size="sm"
          onClick={onClearAll}
      ...
      <div className="flex flex-wrap gap-2">
        ...
        {((filters.contractValueMin && filters.contractValueMin > 0) || (filters.contractValueMax && filters.contractValueMax < 10000000000)) && (
          <Badge
            variant="outline"
            className="border-green-500 text-green-500"
          >
            {formatCurrency(filters.contractValueMin || 0)} - {formatCurrency(filters.contractValueMax || 10000000000)}
            <button
