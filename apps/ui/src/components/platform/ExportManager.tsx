	...
	const getAvailableFormats = () => {
		const formats = [
			...
			},
			{
				...
				label: "JSON Data",
				icon: FilePlus,
				description: "Best for API integration",
			},
		];
						...
						{!exportSuccess ? (
													...
													<div className="flex items-start gap-3">
														...
														<div className="text-left">
															...
															<p className="text-xs text-gray-500 mt-1">
																...
																{
																	formatSizes[
																		format.value as keyof typeof formatSizes
																	]
																}
															</p>
														</div>
										...
										{dataType === "analysis" && (
											<Checkbox
												...
												onCheckedChange={(checked) =>
													setExportOptions((prev) => ({
														...prev,
														includeAISummaries: checked as boolean,
													}))
												}
												label="AI Insights"
										...
										<div className="flex items-center gap-3">
											...
											<div className="flex-1">
												...
												<p className="text-xs text-gray-400">
													Create a secure link valid for 30 days
												</p>
											</div>
										</div>
								...
								<div className="p-4 bg-dark-gold/50 rounded-lg space-y-3">
									<div className="flex items-center gap-3">
										...
										<div>
											...
											<p className="text-xs text-gray-400">
												Automatically export on a regular basis
											</p>
										</div>
									</div>
									{isScheduled && (
							...
							<div className="text-center py-8">
								...
								<p className="text-sm text-gray-400 mb-6">
									Your {exportOptions.format.toUpperCase()} export has been
									generated
								</p>
								...
								{emailRecipients && (
									<div className="bg-dark-gold rounded-lg p-4 mb-4">
										<div className="flex items-center gap-2 text-sm text-gray-300">
											...
											<span>
												Email sent to {emailRecipients.split(",").length}{" "}
												recipient(s)
											</span>
										</div>
									</div>
					...
					{!exportSuccess && (
						<ModalFooter className="border-t border-gray-800 pt-4">
							<div className="flex justify-between items-center w-full">
								<p className="text-xs text-gray-400">
									Export includes {Array.isArray(data) ? data.length : 1}{" "}
									item(s)
								</p>
