...
export function IcebergOpportunityCard({
	opportunity,
	onSelect,
}: IcebergOpportunityCardProps) {
	// Get tier color
	...
	const hiddenRevenue =
		opportunity.revenue.subcontractor - opportunity.revenue.prime;
			...
			<CardContent className="p-4">
				...
				<div className="flex items-start justify-between mb-3">
					...
					<div className="flex items-center gap-2">
						...
						<div
							className={`text-2xl font-bold ${getScoreColor(opportunity.scores.iceberg)}`}
						>
				...
				<div className="flex items-center justify-between pt-2 border-t border-gray-700">
					<div className="flex items-center gap-2">
						{opportunity.advantages &&
							Object.keys(opportunity.advantages).length > 0 && (
