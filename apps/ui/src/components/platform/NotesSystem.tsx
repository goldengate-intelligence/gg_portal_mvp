...
export function NotesSystem({
	...
	const [notes, setNotes] = useState<Note[]>([
		{
			...
			content:
				"Strong contractor with proven track record in defense contracts. Consider for upcoming RFP.",
		...
		},
		{
			...
			title: "Meeting Notes",
			content:
				"Discussed partnership opportunities. CEO expressed interest in subcontracting arrangements.",
	...
	const handleAddTag = () => {
		if (
			tagInput.trim() &&
			newNote.tags &&
			!newNote.tags.includes(tagInput.trim())
		) {
			setNewNote((prev) => ({
				...prev,
					...
					<div className="flex items-center justify-between">
						<div className="flex items-center gap-2">
							...
							<h3
								...
								style={{ fontFamily: "Genos, sans-serif", fontSize: "16px" }}
							>
								Notes & Observations
							</h3>
						</div>
				...
				{filteredNotes.length === 0 ? (
					...
					filteredNotes.map((note) => (
						<HudCard
							...
							variant="default"
							priority="medium"
							className="group border-gray-700/30"
						>
							<div
								className="p-4"
								style={{
										...
										<div className="flex items-start justify-between mb-2">
											<div className="flex-1">
												...
												<div className="flex items-center gap-3 flex-wrap">
													<div
														className={`inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs font-medium border ${getPriorityColor(note.priority)}`}
													>
