			...
			<div className="relative">
				...
				{!isMinimized && (
					...
					>
						{/* Header */}
						<div
							className="border-b border-gray-700/30 px-4 py-5 flex items-center justify-between flex-shrink-0"
						...
						>
							<div className="flex items-center space-x-3">
								...
								<h3
									className="text-gray-200 font-normal tracking-wider"
									style={{
							...
							{isTyping && (
								<div className="flex justify-start">
									<div className="bg-gray-800/80 text-gray-200 border border-gray-700/50 rounded-lg px-3 py-2 text-sm max-w-[80%]">
										<div className="flex space-x-1">
											<div
												className="h-2 w-2 bg-[#D2AC38] rounded-full animate-bounce"
						...
						{/* Input */}
						<div
							className="border-t border-gray-700/30 px-4 flex-shrink-0"
							style={{
								...
								<input
									...
									placeholder={
										chatContext.entityContext
											? chatContext.entityContext.entityType ===
												"risk_configuration"
