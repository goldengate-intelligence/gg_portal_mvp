			...
			>
				<ModalHeader className="border-b border-yellow-500/20 pb-4">
					<div className="flex items-start justify-between">
						<div>
							<ModalTitle className="text-2xl mb-2">
								{contractor.name}
							</ModalTitle>
							{contractor.dbaName && (
								...
								<div className="space-y-6">
									...
									<div className="grid grid-cols-1 md:grid-cols-3 gap-4">
										...
										<MetricCard
											...
											value={
												contractor.pastPerformanceScore?.toString() || "N/A"
											}
									...
									<div className="space-y-4">
										...
										<div className="grid grid-cols-2 gap-4 text-sm">
											<div>
												<span className="text-gray-400 font-aptos">
													Location:
												</span>
											...
											<div>
												...
												<span className="ml-2 text-white font-aptos">
													{contractor.annualRevenue
														? formatCurrency(contractor.annualRevenue)
														: "N/A"}
												</span>
											</div>
											<div>
									...
									<div className="space-y-6">
										...
										<div className="grid grid-cols-3 gap-4">
											...
											<MetricCard
												...
												value={formatCurrency(
													networkData.networkSummary.totalNetworkValue,
												)}
											...
											<MetricCard
												className="bg-lighter-gray border-yellow-500/10"
												title="Avg Strength"
												value={networkData.networkSummary.avgStrengthScore.toFixed(
													0,
												)}
												...
												<div className="space-y-2">
													{networkData.relationships.asPrime.partners
														...
														.map((partner: any, idx: number) => (
															<div
																key={idx}
																className="bg-dark-gray rounded p-3 flex items-center justify-between"
															>
																<div>
										...
										{networkData.relationships.asSubcontractor.count > 0 && (
											<div>
												<h4 className="text-lg font-semibold text-yellow-500 mb-3">
													As Subcontractor (
													{networkData.relationships.asSubcontractor.count}{" "}
													primes)
												</h4>
												<div className="space-y-2">
