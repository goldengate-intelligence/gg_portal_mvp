		...
		<div className="space-y-4">
				...
				>
					<div className="flex items-center justify-between mb-3">
						...
						<div className="flex items-center gap-2">
							...
							<span
								className="text-[10px] text-yellow-400 tracking-wider font-light"
					...
					<p className="text-sm text-gray-400">
						Analyzing{" "}
						{entityType === "contractor"
							? (entity as Contractor).name
							: (entity as Opportunity).title}
					</p>
				</div>
			</HudCard>
			...
			{messages.length > 0 && (
				<HudCard
					variant="default"
					priority="medium"
					className="border-gray-700/30 max-h-96 overflow-y-auto"
				>
					<div
												...
												{message.role === "assistant" && (
													<div className="flex items-center gap-2 pt-2 border-t border-yellow-500/20">
														...
														<Button
															...
															size="sm"
															onClick={() =>
																generateSummary("Provide more details")
															}
														>
