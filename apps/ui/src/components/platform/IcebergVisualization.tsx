...
export function IcebergVisualization({
	...
	const tier2 = subRevenue * 0.3; // Tier 2 subs
	const tier3 = subRevenue * 0.2; // Tier 3 subs
	const tier4 = subRevenue * 0.1; // Tier 4 subs
		...
		<div className="relative w-full max-w-4xl mx-auto p-6 bg-gradient-to-b from-gray-900 to-black rounded-lg">
			...
			<div className="text-center mb-8">
				...
				<p className="text-gray-400 text-sm">
					{hiddenPercentage.toFixed(0)}% of revenue hidden •{" "}
					{subToPrimeRatio
						? `${subToPrimeRatio.toFixed(1)}x more sub than prime`
						: "Significant subcontractor activity"}{" "}
					• Score: {icebergScore}/100
				</p>
			</div>
			...
			<div className="absolute top-32 right-8 text-xs text-gray-500 italic max-w-[200px] text-right">
				...
				{contractorName} shows {formatCurrency(primeRevenue)} in prime contracts
				but has {formatCurrency(subRevenue)} in subcontracts
			</div>
			...
			<div className="relative w-full h-[650px] flex items-center justify-center">
				...
				{/* SVG Iceberg */}
				<svg
					className="w-full max-w-[600px] h-full drop-shadow-[0_10px_30px_rgba(0,0,0,0.5)] animate-float"
					viewBox="0 0 400 600"
				...
				>
					<defs>
						...
						<linearGradient id="aboveWater" x1="0%" y1="0%" x2="100%" y2="100%">
							<stop
								offset="0%"
								style={{ stopColor: "#F5FBFF", stopOpacity: 1 }}
							/>
							<stop
								offset="100%"
								style={{ stopColor: "#D0E7FF", stopOpacity: 1 }}
							/>
						</linearGradient>
						...
						<linearGradient id="grad1" x1="0%" y1="0%" x2="100%" y2="100%">
							<stop
								offset="0%"
								style={{ stopColor: "#87CEEB", stopOpacity: 0.95 }}
							/>
							<stop
								offset="100%"
								style={{ stopColor: "#6BB6DE", stopOpacity: 0.95 }}
							/>
						</linearGradient>
						...
						<linearGradient id="grad2" x1="0%" y1="0%" x2="100%" y2="100%">
							<stop
								offset="0%"
								style={{ stopColor: "#5FA8D3", stopOpacity: 0.9 }}
							/>
							<stop
								offset="100%"
								style={{ stopColor: "#4A90E2", stopOpacity: 0.9 }}
							/>
						</linearGradient>
						...
						<linearGradient id="grad3" x1="0%" y1="0%" x2="100%" y2="100%">
							<stop
								offset="0%"
								style={{ stopColor: "#3A7BC8", stopOpacity: 0.85 }}
							/>
							<stop
								offset="100%"
								style={{ stopColor: "#2E5C8A", stopOpacity: 0.85 }}
							/>
						</linearGradient>
						...
						<linearGradient id="grad4" x1="0%" y1="0%" x2="100%" y2="100%">
							<stop
								offset="0%"
								style={{ stopColor: "#254E70", stopOpacity: 0.8 }}
							/>
							<stop
								offset="100%"
								style={{ stopColor: "#1A3A52", stopOpacity: 0.8 }}
							/>
						</linearGradient>
						...
						<linearGradient id="grad5" x1="0%" y1="0%" x2="100%" y2="100%">
							<stop
								offset="0%"
								style={{ stopColor: "#152A3E", stopOpacity: 0.75 }}
							/>
							<stop
								offset="100%"
								style={{ stopColor: "#0F1E2E", stopOpacity: 0.75 }}
							/>
						</linearGradient>
					</defs>
					...
					<polygon
						points="200,80 185,130 195,132 205,131 215,133 212,130"
						fill="url(#aboveWater)"
						stroke="#D0E7FF"
						strokeWidth="1"
					/>
					...
					<polygon
						points="185,132 215,133 235,180 240,210 160,210 165,180"
						fill="url(#grad1)"
						stroke="#6BB6DE"
						strokeWidth="0.5"
					/>
					...
					<polygon
						points="160,210 240,210 265,260 270,300 135,300 130,260"
						fill="url(#grad2)"
						stroke="#4A90E2"
						strokeWidth="0.5"
					/>
					...
					<polygon
						points="135,300 270,300 290,360 295,400 110,400 105,360"
						fill="url(#grad3)"
						stroke="#2E5C8A"
						strokeWidth="0.5"
					/>
					...
					<polygon
						points="110,400 295,400 305,460 300,490 100,490 95,460"
						fill="url(#grad4)"
						stroke="#1A3A52"
						strokeWidth="0.5"
					/>
					...
					<polygon
						points="100,490 300,490 280,540 200,560 120,540"
						fill="url(#grad5)"
						stroke="#0F1E2E"
						strokeWidth="0.5"
					/>
				...
				<div className="absolute top-[15%] right-[52%] flex items-center text-[#87CEEB]">
					...
					<div className="w-24 h-0.5 bg-current mx-4" />
				...
				<div className="absolute top-[35%] left-[58%] flex items-center text-[#5FA8D3]">
					...
					<div className="w-20 h-0.5 bg-current mx-4" />
					<div>
						<span className="text-xs uppercase tracking-wider block">
							Direct to Prime
						</span>
				...
				<div className="absolute top-[48%] right-[52%] flex items-center text-[#4A90E2]">
					...
					<div className="w-28 h-0.5 bg-current mx-4" />
