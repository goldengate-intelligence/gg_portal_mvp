...
export const featureOptions: Record<string, FeatureOption> = {
	...
	all_procurement_events: {
		...
		description:
			"Monitor all procurement-related activities and events (12 months)",
		unit: "events",
		defaultType: "threshold",
		category: "activity",
	},
	...
	composite_score: {
		...
		description:
			"80th percentile among 247 peers in Q4 with primary NAICS of 332312",
		unit: "pts",
		defaultType: "range",
	...
	award_utilization: {
		...
		description:
			"Utilization rate of incoming contract awards and opportunities",
		unit: "%",
