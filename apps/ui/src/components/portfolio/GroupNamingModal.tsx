...
export function GroupNamingModal({ isOpen, onClose, onConfirm, defaultName }: GroupNamingModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center">
      <div className="bg-gradient-to-br from-gray-900/95 via-gray-800/90 to-gray-900/95 border border-[#D2AC38]/30 rounded-xl p-6 w-96 max-w-md mx-4 shadow-2xl">
        {/* Header */}
        <div className="mb-6">
          <h3 className="text-xl font-light text-white mb-2" style={{ fontFamily: 'system-ui, -apple-system, sans-serif' }}>
            Create Asset Group
          </h3>
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-6">
            <label htmlFor="groupName" className="block text-sm font-medium text-[#D2AC38]/80 mb-2">
              Group Name
            </label>
            <input
              id="groupName"
