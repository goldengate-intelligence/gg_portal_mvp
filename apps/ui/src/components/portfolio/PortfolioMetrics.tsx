  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
      {metrics.map((metric, index) => (
        <div key={metric.title} className="rounded-lg p-4 border border-gray-700/50 hover:border-gray-600/40 transition-all group relative overflow-hidden">
          ...
          <div className="absolute left-0 top-0 bottom-0 w-[2px]" style={{ backgroundColor: metric.accentColor }}></div>
            ...
            <div className="pl-2">
              ...
              <div className="space-y-2">
                <div className="flex items-baseline gap-1">
                  <span className="font-medium" style={{ color: metric.accentColor, fontSize: '30px', lineHeight: '1' }}>
                    {metric.value}
                  </span>
                </div>
                ...
                <div className="flex items-center justify-between text-[11px]">
                  <div className="flex items-baseline gap-1.5">
                    <span className="text-white/70 font-medium">{metric.count}</span>
                    <span className="text-gray-500 uppercase tracking-wide">{metric.countLabel}</span>
                  </div>
                  <span className="text-gray-600 uppercase tracking-wider">{metric.timeframe}</span>
                </div>
              </div>
