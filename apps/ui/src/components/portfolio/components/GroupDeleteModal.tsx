    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-[999999] flex items-center justify-center" style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0 }}>
      <div className="bg-gradient-to-br from-gray-900/95 via-gray-800/90 to-gray-900/95 border border-red-500/50 rounded-xl p-6 w-96 max-w-md mx-4 shadow-2xl">
        ...
        <p className="text-gray-400 text-sm mb-6">
          What would you like to do with <span className="font-semibold text-white">{companyName}</span>? You can remove them from this group only or delete them completely from your portfolio.
        </p>
        <div className="space-y-3">
          ...
          >
            ...
            <div className="text-xs text-gray-400 mt-1">Keep in portfolio as individual asset</div>
          </button>
          <button
          ...
          >
            ...
            <div className="text-xs text-gray-400 mt-1">Remove completely from your portfolio</div>
          </button>
          <button
            onClick={onCancel}
