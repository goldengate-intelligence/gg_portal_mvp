...
export function FileUploadModal({
	...
	const getFileIcon = (file: File) => {
		...
		if (type.includes("zip") || type.includes("rar") || extension === "7z")
		...
		>
			...
			>
				...
				>
					...
					>
						<Upload
							className={`w-12 h-12 mx-auto mb-4 ${isDragOver ? "text-cyan-400" : "text-gray-500"}`}
						/>
						<h3 className="text-lg font-medium text-gray-200 mb-2">
							{isDragOver ? "Drop files here" : "Drop files or click to browse"}
						</h3>
						<p className="text-sm text-gray-400 mb-4">
							Upload documents, images, spreadsheets, and more to your knowledge
							base
						</p>
						<p className="text-xs text-gray-500">
							Maximum file size: 50MB • Supported formats: PDF, DOC, XLS, IMG,
							TXT, etc.
						</p>
					</div>
