...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn("px-6 py-4 align-middle text-cyan-400/90 font-sans text-sm [&:has([role=checkbox])]:pr-0 transition-all duration-200 group-hover:text-cyan-300", className)}
    {...props}
  />
))
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (value: number) => {
        ...
        return (
          <div className="flex items-center justify-center">
            <div className={`px-2 py-1 border rounded font-sans text-xs font-bold ${color} flex items-center gap-1`}>
