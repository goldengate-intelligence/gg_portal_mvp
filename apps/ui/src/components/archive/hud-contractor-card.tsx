			...
			<div onClick={onClick} className="p-4">
					...
					<div className="flex items-start gap-2">
						...
						{onToggleFavorite && (
							<button
								...
								aria-label={
									isFavorite ? "Remove from tracking" : "Add to tracking"
								}
							>
								<Target
									className={cn("h-4 w-4", isFavorite && "animate-pulse")}
								/>
							</button>
						)}
					</div>
				...
				<div className="space-y-2 mb-3">
					<TacticalDisplay
						...
						trend={
							contractor.totalContractValue &&
							contractor.totalContractValue > 1e8
								? "up"
								: "stable"
						}
					/>
					...
					<TacticalDisplay
						...
						alert={
							contractor.pastPerformanceScore
								? contractor.pastPerformanceScore < 70
								: undefined
						}
					/>
				</div>
