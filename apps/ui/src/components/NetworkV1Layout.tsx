            ...
            <div className="h-full bg-black/40 border border-gray-700 backdrop-blur-sm rounded-lg p-3 flex flex-col">
              ...
              <div className="grid grid-cols-3 gap-3 mb-2">
                <div className="text-center">
                  <div className="text-[12px] uppercase tracking-wider text-[#9B7EBD]" style={{ fontFamily: 'Genos, sans-serif' }}>DIRECT</div>
              ...
              <div className="col-span-1">
                <div className="h-full">
                  ...
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <div className="text-[10px] text-[#9B7EBD] mt-[1px]">1 ACTIVE</div>
                  </div>
