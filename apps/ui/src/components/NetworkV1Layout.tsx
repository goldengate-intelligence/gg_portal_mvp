...
interface NetworkV1LayoutProps {
	...
	parsePlaceOfPerformance: (location: string) => {
		city: string;
		state: string;
	};
}
...
const createProjection = (width = 959, height = 593) => {
	return d3
		.geoAlbersUsa()
		.scale(1280)
		...
		<div className="space-y-6 min-h-[70vh]">
			...
			<div className="w-full">
				<HudCard
					...
					priority="high"
					isPanel={true}
					className="h-full border-gray-700/30 rounded-xl overflow-hidden shadow-2xl hover:border-gray-600/20 transition-all duration-500 group"
				>
					<div className="p-4 h-full flex flex-col">
						<h3
							className="text-gray-200 font-normal tracking-wider mb-4 uppercase"
						...
						<div className="grid grid-cols-2 gap-6 flex-1">
							...
							<div className="col-span-1">
								<div
									className="border border-gray-700 rounded-xl backdrop-blur-sm p-4 h-full"
									style={{
											...
											<div className="space-y-3">
												...
												<div className="bg-black/40 rounded-lg p-3 border border-[#D2AC38]/20">
													<div className="flex items-center justify-between mb-3">
														<div
															className="text-[12px] uppercase tracking-wider text-[#D2AC38] font-semibold"
															style={{ fontFamily: "Genos, sans-serif" }}
														>
															CONTRACTOR PROFILE
														</div>
														<div className="flex gap-2">
															<div className="px-2 py-0.5 bg-[#D2AC38]/10 rounded text-[12px] text-[#D2AC38]">
																NAICS 332312
															</div>
														</div>
													</div>
													...
													<div className="text-[12px] text-gray-400 leading-relaxed mb-2">
														Manufacturing armor systems and structural
														components for defense vehicles. Trusted by{" "}
														<span className="text-[#9B7EBD]">DOD</span> with
														direct awards, integrated with{" "}
														<span className="text-[#5BC0EB]">major primes</span>
														, managing{" "}
													...
													<div className="text-[10px] text-[#d2ac38] mb-2">
														Military vehicle armor • Structural assemblies •
														Precision hardware
													</div>

													<div className="mt-2 pt-2 border-t border-gray-700/30">
														<div className="text-[10px]">
															<span className="text-[#d2ac38]">PSC:</span>{" "}
															<span className="text-[#d2ac38]">
																5110, 5340, 9515
															</span>
														</div>
													</div>
													...
													<div className="flex items-start gap-3 bg-black/40 rounded-lg p-3 border border-gray-700">
														<div className="mt-0.5">
															<div className="w-10 h-10 rounded-full bg-[#9B7EBD]/20 border-2 border-[#9B7EBD]/60 flex items-center justify-center">
																<span className="text-[14px] text-[#9B7EBD] font-bold">
																	A
																</span>
															</div>
														</div>
														<div className="flex-1">
															<div className="flex items-center gap-2 mb-1">
																...
																<span className="text-[12px] text-[#9B7EBD]">
																	→ DIRECT AWARDS
																</span>
															</div>
															<div className="text-[12px] text-gray-400">
																DOD contracts for vehicle armor systems, field
																equipment hardware
															</div>
															<div className="text-[10px] text-gray-500 mt-1">
																$50M • 1 Award • Department of Defense
															</div>
														</div>
													</div>
													...
													<div className="flex items-start gap-3 bg-black/40 rounded-lg p-3 border border-gray-700">
														<div className="mt-0.5">
															<div className="w-10 h-10 rounded-full bg-[#5BC0EB]/20 border-2 border-[#5BC0EB]/60 flex items-center justify-center">
																<span className="text-[14px] text-[#5BC0EB] font-bold">
																	P
																</span>
															</div>
														</div>
														<div className="flex-1">
															<div className="flex items-center gap-2 mb-1">
																...
																<span className="text-[12px] text-[#5BC0EB]">
																	→ SUBCONTRACT AWARDS
																</span>
															</div>
															<div className="text-[12px] text-gray-400">
																Manufacturing support for MegaCorp Industries &
																Global Defense Systems
															</div>
															<div className="text-[10px] text-gray-500 mt-1">
																$380M • 91 Awards • 2 Prime Contractors
															</div>
														</div>
													</div>
													...
													<div className="flex items-start gap-3 bg-black/40 rounded-lg p-3 border border-gray-700">
														<div className="mt-0.5">
															<div className="w-10 h-10 rounded-full bg-[#FF4C4C]/20 border-2 border-[#FF4C4C]/60 flex items-center justify-center">
																<span className="text-[14px] text-[#FF4C4C] font-bold">
																	S
																</span>
															</div>
														</div>
														<div className="flex-1">
															<div className="flex items-center gap-2 mb-1">
																...
																<span className="text-[12px] text-[#FF4C4C]">
																	→ PROCUREMENT ORDERS
																</span>
															</div>
															<div className="text-[12px] text-gray-400">
																Raw materials, specialized coatings, precision
																machining services
															</div>
															<div className="text-[10px] text-gray-500 mt-1">
																$29M • 25 Orders • 3 Suppliers
															</div>
														</div>
													</div>
												</div>
							...
							<div className="col-span-1">
								<div
									className="border border-gray-700 rounded-xl backdrop-blur-sm p-4 flex flex-col h-full"
									style={{
										backgroundColor: CONTRACTOR_DETAIL_COLORS.containerColor,
									}}
								>
									...
									<div className="flex-1 relative overflow-hidden rounded-lg transition-all duration-300 min-h-[300px]">
										<GoldengateNetworkGraph
											...
											nodes={[
												...
												...(networkData.relationships?.asSubcontractor?.partners
													?.slice(0, 8)
													.map((p: any) => ({
														id: p.primeUei,
												...
												...(networkData.relationships?.asPrime?.partners
													?.slice(0, 8)
													.map((p: any) => ({
														id: p.subUei,
									...
									<div className="bg-black/40 border border-gray-700 rounded-lg p-3 mt-3">
										<div className="grid grid-cols-3 gap-2 text-center">
											<div>
												<div
													className="text-[12px] uppercase tracking-wider text-gray-500 mb-1"
													style={{ fontFamily: "Genos, sans-serif" }}
												>
													INFLOWS
												</div>
				...
				<div className="col-span-1">
					...
					>
						<div className="p-4 relative flex flex-col h-full">
							...
							<div
								className="flex-1 border border-gray-700 rounded-xl backdrop-blur-sm p-4 flex flex-col"
								style={{
									backgroundColor: CONTRACTOR_DETAIL_COLORS.containerColor,
								}}
							>
									...
									<div className="h-full bg-black/40 border border-gray-700 backdrop-blur-sm rounded-lg p-3 flex flex-col">
										...
										<div className="grid grid-cols-3 gap-3 mb-2">
											<div className="text-center">
												<div
													className="text-[12px] uppercase tracking-wider text-[#9B7EBD]"
													style={{ fontFamily: "Genos, sans-serif" }}
												>
													DIRECT
												</div>
												<div className="py-0.5">
													<div
														className="font-bold text-green-400 leading-tight"
														style={{ fontSize: "38px" }}
													>
														$50M
													</div>
											...
											<div className="text-center">
												<div
													className="text-[12px] uppercase tracking-wider text-[#5BC0EB]"
													style={{ fontFamily: "Genos, sans-serif" }}
												>
													PRIME
												</div>
											...
											<div className="text-center">
												<div
													className="text-[12px] uppercase tracking-wider text-[#FF4C4C]"
													style={{ fontFamily: "Genos, sans-serif" }}
												>
													SUB
												</div>
												<div className="py-0.5">
													<div
														className="font-bold text-red-400 leading-tight"
														style={{ fontSize: "38px" }}
													>
														$
														{formatMoney(
										...
										<div className="grid grid-cols-3 gap-4 flex-1">
											...
											<div className="col-span-1">
												<div className="h-full">
													...
													<div className="flex items-center justify-between mb-3">
														<div className="flex items-center gap-2">
															<div className="w-2 h-2 bg-[#9B7EBD] rounded-full" />
															<div
																className="text-xs font-medium text-gray-400 uppercase tracking-wide -mt-[1px]"
																style={{ fontFamily: "Genos, sans-serif" }}
															>
																DIRECT AWARDS
															</div>
														</div>
														<div className="text-[10px] text-[#9B7EBD] mt-[1px]">
															1 ACTIVE
														</div>
													</div>
													...
													<div className="space-y-2 overflow-y-auto max-h-[220px]">
														<div className="bg-black/40 rounded-lg p-2 border border-[#9B7EBD]/20 hover:border-[#9B7EBD]/40 transition-colors">
															...
															<div className="flex items-center justify-between mt-1">
																...
																<div className="text-[10px] text-[#9B7EBD]">
																	100%
																</div>
															</div>
														</div>
												...
												<div className="h-full">
													...
													<div className="flex items-center justify-between mb-3">
														...
														<div className="text-[10px] text-[#5BC0EB] mt-[1px]">
															{networkData.relationships?.asSubcontractor?.partners?.reduce(
																(sum: number, p: any) =>
																	sum + (p.sharedContracts || 0),
																0,
															) || 0}{" "}
															ACTIVE
														</div>
													...
													<div className="space-y-2 overflow-y-auto max-h-[220px]">
														{networkData.relationships?.asSubcontractor?.partners
															...
															.map((partner: any, index: number) => (
																<div
																	key={`prime-${index}`}
																	className="bg-black/40 rounded-lg p-2 border border-[#5BC0EB]/20 hover:border-[#5BC0EB]/40 transition-colors"
																>
																	<div className="text-xs text-gray-300 font-medium">
																		{partner.primeName}
																	</div>
												...
												<div className="h-full">
													...
													<div className="flex items-center justify-between mb-3">
														...
														<div className="text-[10px] text-[#FF4C4C] mt-[1px]">
															{networkData.relationships?.asPrime?.partners?.reduce(
																(sum: number, p: any) =>
																	sum + (p.sharedContracts || 0),
																0,
															) || 0}{" "}
													...
													<div className="space-y-2 overflow-y-auto max-h-[220px]">
														{networkData.relationships?.asPrime?.partners
															...
															.map((partner: any, index: number) => (
																<div
																	key={`sub-${index}`}
																	className="bg-black/40 rounded-lg p-2 border border-[#FF4C4C]/20 hover:border-[#FF4C4C]/40 transition-colors"
																>
																	<div className="text-xs text-gray-300 font-medium">
																		{partner.subName}
																	</div>
																	<div className="flex items-center justify-between mt-1">
																		...
																		<div className="text-[10px] text-[#FF4C4C]">
																			{(
																				(partner.sharedRevenue /
																					(networkData.relationships?.asPrime
																						?.totalValue || 1)) *
																				100
																			).toFixed(0)}
																			%
					...
					>
						<div className="p-4 relative flex flex-col h-full">
							...
							>
									...
									<div className="relative w-full h-full">
										...
										>
											...
											{[
												...
												const leftPercent =
													(projectedCoords[0] / mapWidth) * 100;
												const topPercent =
													(projectedCoords[1] / mapHeight) * 100;
								...
								<div className="mt-2">
									<div
										className="flex justify-center gap-4 font-light"
										style={{ fontSize: "14px" }}
									>
										<div className="flex items-center gap-1">
											<div className="w-2 h-2 rounded-full bg-[#D2AC38]" />
											<span className="text-[#D2AC38]">Contractor HQ</span>
										</div>
										<div className="flex items-center gap-1">
											<div className="w-2 h-2 rounded-full bg-[#5BC0EB]" />
											<span className="text-[#5BC0EB]">Parent HQ</span>
										</div>
										<div className="flex items-center gap-1">
											<div className="w-2 h-2 rounded-full bg-[#FF4C4C]" />
