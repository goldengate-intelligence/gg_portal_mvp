...
import { History, X, MoreHorizontal } from 'lucide-react';
        ...
        <div className="space-y-1">
              ...
              <div className="p-3 border-l-4 border-blue-500">
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs text-blue-400">{queryExecutionTime}ms</span>
                  </div>
                  {onCancelQuery && (
                    <button
          ...
          {queryHistory.map((entry) => (
            ...
            >
              <div className={`p-3 border-l-4 ${
                ...
                <div className="text-xs text-gray-300 truncate" title={entry.query}>
                  {entry.query}
                </div>
              </div>
            </div>
          ...
          {queryHistory.length === 0 && !isExecuting && (
            <div className="text-center text-gray-500 py-8">
              ...
              <div className="text-xs mt-1">Your search history will appear here</div>
            </div>
          )}
        </div>
      </div>
