...
import { MessageSquare, X, Bot, Paperclip } from 'lucide-react';
...
export function DiscoveryInterface() {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      // Add to history
      actions.addQueryToHistory(state.searchQuery, 'completed', response.results.length);
                    ...
                    <ChartStyleContainer>
                      <div className="relative h-full">
                        ...
                        <ResultsTable
                          ...
                          onToggleColumnSelector={() => actions.setShowColumnSelector(!state.showColumnSelector)}
