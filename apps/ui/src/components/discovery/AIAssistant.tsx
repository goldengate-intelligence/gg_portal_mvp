...
import { Bot, X, Send, ChevronRight, Pin, Trash2 } from 'lucide-react';
  ...
  return (
    <>
      {isOpen && (
        ...
        >
          <div className="space-y-3 px-1">
            ...
            <div className="text-center py-8">
              ...
              <p className="text-gray-400 text-sm">I'm here to help with all your research and platform needs. Ask me anything!</p>
        ...
        {/* AI Input */}
        <div className="border-t border-gray-700 pt-3" style={{ marginBottom: '64px' }}>
        ...
        <div className="absolute flex items-center gap-8" style={{ left: '24px', bottom: '32px' }}>
          ...
          >
            <svg className="w-5 h-5 text-purple-400 hover:text-purple-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <button
            ...
            onMouseLeave={() => setActiveTooltip(null)}
          >
            <svg className="w-5 h-5 text-cyan-400 hover:text-cyan-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <button
            ...
            onMouseLeave={() => setActiveTooltip(null)}
          >
            <svg className="w-5 h-5 text-teal-400 hover:text-teal-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
