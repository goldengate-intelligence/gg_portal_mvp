...
export const PeopleSection: React.FC<PeopleSectionProps> = ({
	...
	return (
		<div className="space-y-6">
			...
			<div
				className={`border border-gray-700/30 rounded-xl p-4 ${CONTRACTOR_DETAIL_COLORS.panelColor}`}
			>
							...
							<div className="p-4 flex flex-col h-full">
								...
								<div className="flex items-start justify-between mb-3">
									<div className="flex-1">
										<h3
											className="text-[#D2AC38] font-normal tracking-wide mb-1"
											style={{
								...
								<div
									className="border border-gray-800 rounded-lg p-3 space-y-2.5"
									style={{
										backgroundColor: CONTRACTOR_DETAIL_COLORS.containerColor,
									}}
								>
