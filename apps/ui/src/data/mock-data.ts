...
export const mockOpportunities: Opportunity[] = [
	{
		...
		description:
			"Development and integration of advanced combat vehicle systems for next-generation military applications.",
		...
		aiSummary:
			"High-value combat vehicle contract with significant technology requirements and multiple option periods.",
		keyRequirements: [
			"Systems Integration",
			"Advanced Materials",
			"Cybersecurity",
	...
	},
	{
		...
		description:
			"Comprehensive IT infrastructure services including cloud, network, and security solutions.",
		...
		competitionLevel: "full-open",
		aiSummary:
			"Large-scale indefinite delivery vehicle for federal IT infrastructure modernization.",
		keyRequirements: [
			"Cloud Services",
	...
	},
	{
		...
		description:
			"Advanced analytics and data management services for healthcare program optimization.",
		...
		aiSummary:
			"Healthcare data analytics contract with focus on Medicare and Medicaid program improvement.",
		keyRequirements: [
	...
	},
	{
		...
		description:
			"Comprehensive IT support services for Defense Logistics Agency operations worldwide.",
		agency: "Department of Defense",
		...
		competitionLevel: "full-open",
		aiSummary:
			"Multi-billion dollar IT services contract supporting global logistics operations.",
		keyRequirements: [
			"IT Support",
			"Help Desk Services",
...
export const mockPortfolios: Portfolio[] = [
	{
		...
		description:
			"Major defense contractors with significant federal contract portfolios",
		userId: "user1",
		organizationId: "org1",
		contractors: [
			{
...
export const mockAnalysisResults: AnalysisResult[] = [
	{
		...
		userId: "user1",
		summary:
			"Lockheed Martin shows strong revenue growth with consistent federal contract performance. Revenue has grown 8.2% annually over the past 5 years.",
		keyFindings: [
	...
	},
	{
		...
		userId: "user1",
		summary:
			"Accenture Federal Services demonstrates strong compliance record with no significant regulatory issues. Minor concerns around subcontractor management processes.",
		keyFindings: [
...
export const getOpportunitiesByAgency = (agency: string): Opportunity[] => {
	return mockOpportunities.filter(
		(opportunity) => opportunity.agency === agency,
	);
};

export const getAnalysisResultsByContractor = (
	contractorId: string,
): AnalysisResult[] => {
	return mockAnalysisResults.filter(
		(result) => result.contractorId === contractorId,
	);
};
...
export const generateMockContractor = (
	...
	return {
		...
		lifecycleStage: lifecycleStages[
			Math.floor(Math.random() * lifecycleStages.length)
		] as any,
		businessMomentum: momentum[
			Math.floor(Math.random() * momentum.length)
		] as any,
		ownershipType: ownership[
			Math.floor(Math.random() * ownership.length)
		] as any,
