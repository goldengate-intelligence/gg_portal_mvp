        ...
        <div className="relative border-b border-gray-800/60" style={{ backgroundColor: CONTRACTOR_DETAIL_COLORS.backgroundColor }}>
          ...
          <div className="container mx-auto px-6 py-8 max-w-7xl">
            ...
            <div className="grid grid-cols-4 gap-6 mt-2">
              <div className={cn("rounded-lg p-4 border border-gray-700/50 hover:border-gray-600/40 transition-all group relative overflow-hidden", CONTRACTOR_DETAIL_COLORS.panelColor)}>
                ...
                <div className="pl-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-3 text-sm">
                      <span className="text-white/80">278</span>
                      <span className="text-gray-500 text-xs">contracts</span>
                      <span className="text-gray-700">•</span>
                      <span className="text-gray-500 text-[11px]">ALL TIME</span>
                    </div>
                  </div>
                ...
                <div className="pl-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-3 text-sm">
                      ...
                      <span className="text-gray-500 text-xs">contracts</span>
                      <span className="text-gray-700">•</span>
                      <span className="text-gray-500 text-[11px]">PERFORMING</span>
                    </div>
                  </div>
                ...
                <div className="pl-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-3 text-sm">
                      ...
                      <span className="text-gray-500 text-xs">recognized</span>
                      <span className="text-gray-700">•</span>
                      <span className="text-gray-500 text-[11px]">12 MONTHS</span>
                    </div>
                  </div>
              ...
              <div className={cn("rounded-lg p-4 border border-gray-700/50 hover:border-gray-600/40 transition-all group relative overflow-hidden", CONTRACTOR_DETAIL_COLORS.panelColor)}>
                ...
                <div className="pl-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-3 text-sm">
                      <span className="text-white/80">Est</span>
                      <span className="text-gray-500 text-xs">potential</span>
                      <span className="text-gray-700">•</span>
                      <span className="text-gray-500 text-[11px]">FORECAST</span>
                    </div>
                  </div>
              ...
              <div className="space-y-8">
                                  ...
                                  <GoldengateBarChart
                                    ...
                                    data={{
                                      ...
                                      datasets: [{
                                        ...
                                        backgroundColor: 'rgba(155, 126, 189, 0.4)',
                                        borderColor: '#9B7EBD',
                                        borderWidth: 2,
                                      }]
                                    }}
                                ...
                                <div className="border-2 border-gray-600/30 rounded-xl backdrop-blur-sm p-3" style={{ backgroundColor: CONTRACTOR_DETAIL_COLORS.containerColor }}>
                                  ...
                                  <div className="grid grid-cols-2 gap-6 mb-3">
                                      ...
                                      <div className="relative">
                                        ...
                                        <div className="absolute -top-1 -right-1 w-7 h-7 bg-[#15803d] rounded-full flex items-center justify-center border-2 border-gray-900">
                                          <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
                                            <path d="M10 3.5L12.5 8.5H18L14 12L15.5 18L10 15L4.5 18L6 12L2 8.5H7.5L10 3.5Z"/>
                                          </svg>
                                        </div>
                                      </div>
                                      <div className="text-center">
                                        <div className="text-white text-sm font-medium">Business Development</div>
                                        <div className="text-[#15803d] text-xs uppercase tracking-wide">Elite Performance</div>
                                      </div>
                                    </div>
                                    ...
                                    <div className="flex flex-col items-center gap-2">
                                      ...
                                      <div className="text-center">
                                        <div className="text-white text-sm font-medium">Contract Retention</div>
                                        <div className="text-[#eab308] text-xs uppercase tracking-wide">Growth Opportunity</div>
                                      </div>
                                    </div>
                                  </div>
                ...
                {activeTab === 'contracts' && (
                  <div className="flex gap-4 h-full">
                    {/* Left: Contracts Table - 80% width (4 of 5 units) */}
                      ...
                      <HudCard variant="default" priority="high" isPanel={true} className="h-full border-gray-700/30 rounded-xl overflow-hidden shadow-2xl hover:border-gray-600/20 transition-all duration-500">
                        <div className="p-4 h-full flex flex-col">
                          <div className="flex items-center justify-between mb-4">
                            ...
                            <div className="flex items-center gap-2">
                              <span className="text-[10px] text-gray-500 uppercase tracking-wider">117 TOTAL</span>
                          ...
                          {/* Table Container */}
                          <div className="flex-1 border border-gray-600/20 rounded-xl backdrop-blur-sm p-4" style={{ backgroundColor: CONTRACTOR_DETAIL_COLORS.containerColor }}>
                            <h4 className="font-sans text-xs uppercase tracking-wider text-gray-500 mb-3">
                              CONTRACT PORTFOLIO
                            </h4>
                            <div className="h-full overflow-auto rounded-lg" style={{ backgroundColor: CONTRACTOR_DETAIL_COLORS.backgroundColor }}>
                              <table className="w-full text-xs">
                              <thead className="sticky top-0 bg-black/60 backdrop-blur-sm border-b border-gray-700/50">
                                <tr>
                                  <th className="text-left px-4 py-3 text-gray-500 font-normal uppercase tracking-wider" style={{ fontFamily: 'Genos, sans-serif', fontSize: '12px' }}>Award ID</th>
                                  <th className="text-left px-4 py-3 text-gray-500 font-normal uppercase tracking-wider" style={{ fontFamily: 'Genos, sans-serif', fontSize: '12px' }}>Client</th>
                                  <th className="text-left px-4 py-3 text-gray-500 font-normal uppercase tracking-wider" style={{ fontFamily: 'Genos, sans-serif', fontSize: '12px' }}>Description</th>
                                  <th className="text-left px-4 py-3 text-gray-500 font-normal uppercase tracking-wider" style={{ fontFamily: 'Genos, sans-serif', fontSize: '12px' }}>Value</th>
                                  <th className="text-left px-4 py-3 text-gray-500 font-normal uppercase tracking-wider" style={{ fontFamily: 'Genos, sans-serif', fontSize: '12px' }}>Period</th>
                                  <th className="text-left px-4 py-3 text-gray-500 font-normal uppercase tracking-wider" style={{ fontFamily: 'Genos, sans-serif', fontSize: '12px' }}>NAICS</th>
                                  <th className="text-left px-4 py-3 text-gray-500 font-normal uppercase tracking-wider" style={{ fontFamily: 'Genos, sans-serif', fontSize: '12px' }}>PSC</th>
                                  <th className="text-left px-4 py-3 text-gray-500 font-normal uppercase tracking-wider" style={{ fontFamily: 'Genos, sans-serif', fontSize: '12px' }}>Type</th>
                                  <th className="text-left px-4 py-3 text-gray-500 font-normal uppercase tracking-wider" style={{ fontFamily: 'Genos, sans-serif', fontSize: '12px' }}>Status</th>
                                </tr>
                              </thead>
                              <tbody className="divide-y divide-gray-800/50">
                                {/* Sample contract rows */}
                                {[
                                  { id: 'W912HZ24F0123', client: 'DOD', clientType: 'agency', desc: 'Vehicle Armor System Manufacturing', value: '$12.5M', period: '2024-2029', naics: '332312', psc: '5110', type: 'FIRM-FIXED', status: 'ACTIVE' },
                                  { id: 'MC-2024-0456', client: 'MegaCorp Industries', clientType: 'prime', desc: 'Structural Components for M-ATV', value: '$8.3M', period: '2023-2026', naics: '332312', psc: '2510', type: 'Subcontract', status: 'ACTIVE' },
                                  { id: 'SPE4A024M1789', client: 'DLA', clientType: 'agency', desc: 'Precision Hardware Manufacturing', value: '$3.2M', period: '2024-2025', naics: '332312', psc: '5340', type: 'FIRM-FIXED', status: 'ACTIVE' },
                                  { id: 'N00024-24-C-5432', client: 'NAVY', clientType: 'agency', desc: 'Naval Vessel Protective Plating', value: '$15.7M', period: '2024-2028', naics: '332312', psc: '2090', type: 'COST-PLUS', status: 'ACTIVE' },
                                  { id: 'GDS-SUB-0012', client: 'Global Defense Systems', clientType: 'prime', desc: 'Aircraft Structural Assemblies', value: '$9.8M', period: '2024-2027', naics: '332312', psc: '1560', type: 'Subcontract', status: 'ACTIVE' },
                                  { id: 'W911QX24P0234', client: 'ARMY', clientType: 'agency', desc: 'Combat Vehicle Armor Upgrades', value: '$22.1M', period: '2024-2029', naics: '332312', psc: '2350', type: 'FIRM-FIXED', status: 'OPTION' },
                                  { id: 'HDTRA124C0098', client: 'DTRA', clientType: 'agency', desc: 'Hardened Facility Components', value: '$5.6M', period: '2024-2026', naics: '332312', psc: '5680', type: 'COST-PLUS', status: 'ACTIVE' },
                                  { id: 'MC-2024-1789', client: 'MegaCorp Industries', clientType: 'prime', desc: 'Strategic Material Reserve Parts', value: '$4.3M', period: '2024-2025', naics: '332312', psc: '5110', type: 'Subcontract', status: 'ACTIVE' },
                                  { id: 'W58RGZ-23-C-0156', client: 'DOD', clientType: 'agency', desc: 'MRAP Underbody Protection Systems', value: '$18.9M', period: '2023-2027', naics: '332312', psc: '2355', type: 'IDIQ', status: 'ACTIVE' },
                                  { id: 'N68335-24-C-0234', client: 'NAVY', clientType: 'agency', desc: 'Submarine Hull Reinforcement Plates', value: '$7.2M', period: '2024-2026', naics: '332312', psc: '2030', type: 'FIRM-FIXED', status: 'ACTIVE' },
                                  { id: 'GDS-SUB-0078', client: 'Global Defense Systems', clientType: 'prime', desc: 'Aerospace Grade Fabrication', value: '$11.4M', period: '2024-2028', naics: '332312', psc: '1510', type: 'Subcontract', status: 'ACTIVE' },
                                  { id: 'W31P4Q-24-C-0089', client: 'AMC', clientType: 'agency', desc: 'Ammunition Storage Containers', value: '$6.8M', period: '2024-2026', naics: '332312', psc: '8140', type: 'FIRM-FIXED', status: 'ACTIVE' },
                                  { id: 'HDTRA223C0067', client: 'DTRA', clientType: 'agency', desc: 'Blast Resistant Enclosures', value: '$13.2M', period: '2023-2026', naics: '332312', psc: '5680', type: 'IDIQ', status: 'OPTION' },
                                  { id: 'MC-2024-0123', client: 'MegaCorp Industries', clientType: 'prime', desc: 'Military Specification Fasteners', value: '$2.9M', period: '2024-2025', naics: '332312', psc: '5320', type: 'Subcontract', status: 'ACTIVE' },
                                  { id: 'W52P1J-24-C-0045', client: 'ARMY', clientType: 'agency', desc: 'Tank Track Components Manufacturing', value: '$16.5M', period: '2024-2028', naics: '332312', psc: '2350', type: 'IDIQ', status: 'ACTIVE' },
                                ].map((contract, index) => (
                                  <tr key={index} className="hover:bg-gray-900/20 transition-colors">
                                    <td className="px-4 py-3 text-gray-500 font-mono text-[11px]">{contract.id}</td>
                                    <td className="px-4 py-3">
                                      <span className="font-medium text-sm" style={{
                                        color: contract.clientType === 'agency' ? '#9B7EBD' : '#5BC0EB'
                                      }}>
                                        {contract.client}
                                      </span>
                                    </td>
                                    <td className="px-4 py-3 text-gray-300 text-sm max-w-[250px] truncate">{contract.desc}</td>
                                    <td className="px-4 py-3 text-white font-medium text-sm">{contract.value}</td>
                                    <td className="px-4 py-3 text-gray-500 text-xs">{contract.period}</td>
                                    <td className="px-4 py-3 text-gray-500 font-mono text-xs">{contract.naics}</td>
                                    <td className="px-4 py-3 text-gray-500 font-mono text-xs">{contract.psc}</td>
                                    <td className="px-4 py-3 text-gray-400 text-xs">{contract.type}</td>
                                    <td className="px-4 py-3">
                                      <span className={`px-1.5 py-0.5 rounded text-[9px] font-medium ${
                                        contract.status === 'ACTIVE' ? 'bg-green-500/20 text-green-400' :
                                        contract.status === 'OPTION' ? 'bg-yellow-500/20 text-yellow-400' :
