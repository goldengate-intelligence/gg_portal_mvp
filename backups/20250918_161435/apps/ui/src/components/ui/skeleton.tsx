...
const ContractorCardSkeleton = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => {
  return (
    <div className={cn("rounded-lg border border-yellow-500/20 bg-medium-gray p-6", className)} {...props}>
...
const OpportunityCardSkeleton = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => {
  return (
    <div className={cn("rounded-lg border border-yellow-500/20 bg-medium-gray p-6", className)} {...props}>
      <div className="space-y-4">
        <div className="space-y-2">
...
const SearchSkeleton = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => {
  return (
...
const EmptyState = ({ 
  ...
  return (
    <div className={cn("flex flex-col items-center justify-center p-12 space-y-4 text-center", className)} {...props}>
