...
>(({ className, variant = 'default', ...props }, ref) => {
  const variants = {
    default: "bg-medium-gray border border-yellow-500/20 text-white",
    elevated: "bg-medium-gray border border-yellow-500/20 shadow-lg shadow-black/25 text-white",
    outlined: "bg-transparent border border-yellow-500/30 text-white",
    interactive: "bg-medium-gray border border-yellow-500/20 hover:border-yellow-500 hover:shadow-lg hover:shadow-yellow-500/10 text-white transition-all duration-200 cursor-pointer"
  }
