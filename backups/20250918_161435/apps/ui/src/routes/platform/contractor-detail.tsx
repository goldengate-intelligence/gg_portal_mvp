                      ...
                      <div className="border border-gray-700 rounded-xl p-4 bg-gray-900/40">
                        ...
                        <div className="mb-4">
                          ...
                          <div className="space-y-1.5">
                            {[
                              { code: '332312', label: 'Fabricated Metal', pct: 65, color: '#4EC9B0' },
                              { code: '332313', label: 'Plate Work', pct: 20, color: '#5BC0EB' },
                              { code: '332618', label: 'Wire Products', pct: 10, color: '#D2AC38' },
